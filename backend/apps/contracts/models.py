...
class LLMUsage(SafeDeleteModel):
    """Track LLM usage for contracts and clauses."""
    ...
    provider = models.CharField(max_length=50, verbose_name=_('LLM Provider'))
    ...
    # Context and input
    input_context = models.TextField(blank=True, verbose_name=_('Input Context'))
    generated_content = models.TextField(blank=True, verbose_name=_('Generated Content'))
